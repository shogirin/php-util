...
class Model{
	...
	**/
	public function getList(
		...
		if($order)$sql .= self::__createOrderQuery($order);
		$limit = (int)$limit;
	...
	public function getGroupCount($group, array $args = array(),
		array $order = array(),$page = 1, $limit = 20){
	...
	static public function connect(){
		if(!self::$conn){
			...
			self::$conn = new PDO($ini['dsn'], $ini['username'], $ini['password']);
